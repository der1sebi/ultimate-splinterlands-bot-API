BEGIN TRANSACTION;
--DROP TABLE IF EXISTS "modern_Game" CASCADE;
CREATE TABLE IF NOT EXISTS "modern_Game" (
...
--DROP TABLE IF EXISTS "modern_Team_Card" CASCADE;
CREATE TABLE IF NOT EXISTS "modern_Team_Card" (
...
CREATE TABLE IF NOT EXISTS "modern_Team_Game" (
    ...
    FOREIGN KEY("GameId") REFERENCES "modern_Game"("Id"),
    --FOREIGN KEY("TeamHash") REFERENCES "modern_Team_Card"("TeamHash"),
...
--DROP TABLE IF EXISTS "modern_CachedTeams";
CREATE TABLE IF NOT EXISTS "modern_CachedTeams" (
	"Id"	serial primary key,
	"Ruleset1"	TEXT NOT NULL,
	"Ruleset2"	TEXT NOT NULL,
	"Ruleset3"	TEXT NOT NULL,
